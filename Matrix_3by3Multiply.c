// c program to find multiplication of 3 by 3 matrix using array of array
...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        for (int j = 0; j < n; j++)
        {
            ...
            for (int k = 0; k < n; k++)
            {
                /*multiplying the element of the first matrix with the element of the second matrix 
                and adding them to the element of the third matrix 
                */
